//
//  SelectPayTableViewController.m
//  JM Transfers
//
...
@interface SelectPayTableViewController ()

@end

@implementation SelectPayTableViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    _transfer.payment_method = cell.textLabel.text;
    
    ReceiptViewController *dash = [self.storyboard instantiateViewControllerWithIdentifier:@"receipt"];
